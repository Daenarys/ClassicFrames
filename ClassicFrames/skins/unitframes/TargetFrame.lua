...
local function SkinFrame(frame)
	...
	hooksecurefunc(frame, "CheckClassification", function(self)
		...
		FrameHealthBarContainer.LeftText:SetPoint("LEFT", FrameHealthBarContainer, "LEFT", 5, -1)
		...
		elseif ( classification == "minus" ) then
			...
			FrameHealthBarContainer.LeftText:SetPoint("LEFT", FrameHealthBarContainer, "LEFT", 5, -6)
