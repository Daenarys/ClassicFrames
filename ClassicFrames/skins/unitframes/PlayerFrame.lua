...
function CfPlayerFrame_ToVehicleArt(self, vehicleType)
	...
	CfUnitFrame_SetUnit(CfPetFrame, "player", CfPetFrameHealthBar, CfPetFrameManaBar);
	PetFrame_Update(CfPetFrame);
	CfPlayerFrame_Update();
...
function CfPlayerFrame_ToPlayerArt(self)
	...
	CfUnitFrame_SetUnit(CfPetFrame, "pet", CfPetFrameHealthBar, CfPetFrameManaBar);
	PetFrame_Update(CfPetFrame);
	CfPlayerFrame_Update();
