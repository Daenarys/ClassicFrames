...
CfPowerBarColor["INSANITY"] =			{ r = 0.40, g = 0.00, b = 0.80, atlas = "_Priest-InsanityBar"};
CfPowerBarColor["CHI"] =				{ r = 0.71, g = 1.00, b = 0.92 };
CfPowerBarColor["ARCANE_CHARGES"] =	{ r = 0.10, g = 0.10, b = 0.98 };
