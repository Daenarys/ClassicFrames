...
PetFrameHealthBarText:SetPoint("CENTER", PetFrame, "TOPLEFT", 81, -26)
...
PetFrameHealthBarTextRight:SetPoint("RIGHT", PetFrame, "TOPLEFT", 114, -26)
PetFrameManaBarText:ClearAllPoints()
PetFrameManaBarText:SetPoint("CENTER", PetFrame, "TOPLEFT", 82, -36)
