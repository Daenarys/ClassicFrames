...
f:SetScript("OnEvent", function(self, event, name)
	if name == "Blizzard_GuildBankUI" then
		GuildBankFrame.CloseButton:SetSize(32, 32)
		GuildBankFrame.CloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Disabled")
		GuildBankFrame.CloseButton:SetNormalTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Up")
		GuildBankFrame.CloseButton:SetPushedTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Down")
		GuildBankFrame.CloseButton:SetHighlightTexture("Interface\\Buttons\\UI-Panel-MinimizeButton-Highlight")
		GuildBankFrame.CloseButton:ClearAllPoints()
		GuildBankFrame.CloseButton:SetPoint("TOPRIGHT", 4, 5)
