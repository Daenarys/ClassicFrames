...
function LootFrame_OnLoad(self)
	...
	CullCorner(self.NineSlice.TopLeftCorner, 0.263671875, 0.521484375, 0.263671875, 0.521484375, .65, .6, 0, 0)
	CullCorner(self.NineSlice.TopRightCorner, 0.001953125, 0.259765625, 0.263671875, 0.521484375, .25, .4, 1, 0)
	CullCorner(self.NineSlice.BottomLeftCorner, 0.001953125, 0.259765625, 0.001953125, 0.259765625, .55, .4, 0, 1)
	CullCorner(self.NineSlice.BottomRightCorner, 0.263671875, 0.521484375, 0.001953125, 0.259765625, .35, .4, 1, 1)
end
