...
LootFrame.ScrollBar.Track.Begin:Hide()
LootFrame.ScrollBar.Track.End:Hide()
LootFrame.ScrollBar.Track.Middle:Hide()

ApplyScrollBarArrow(LootFrame.ScrollBar, true)
