...
function ApplyDialogHeader(frame)
	...
	if (frame.TitleFrame.BackgroundMiddle == nil) then
		...
		frame.TitleFrame.BackgroundMiddle:SetHeight(40)
	...
	hooksecurefunc(frame.Header, "Setup", function(self)
		frame.TitleFrame.BackgroundMiddle:SetWidth(min(240, max(140, self.Text:GetWidth())))
	end)
end
