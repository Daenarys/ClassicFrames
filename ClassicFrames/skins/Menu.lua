...
local function IsDialogMenu(owner)
	...
	return (owner == DressUpFrameCustomSetDropdown)
		...
		or (owner == CommunitiesFrame.StreamDropdown)
		...
		or (LFGBrowseFrame and owner == LFGBrowseFrameActivityDropdown)
		or (LFGBrowseFrame and owner == LFGBrowseFrameCategoryDropdown)
		or (LFGListingFrame and owner == LFGListingFrameGroupRoleButtonsRoleDropdown)
