...
PVPReadyDialogCloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-HideButton-Disabled")
...
ReadyStatus.CloseButton:SetDisabledTexture("Interface\\Buttons\\UI-Panel-HideButton-Disabled")
