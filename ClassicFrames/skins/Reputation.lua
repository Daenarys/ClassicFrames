...
function CfReputationFrame_SetRowType(factionRow, isChild, isHeader, hasRep)	--rowType is a binary table of type isHeader, isChild
	...
	for i=1, NUM_FACTIONS_DISPLAYED, 1 do
		...
		if ( factionIndex <= numFactions ) then
			...
			if ( factionID and C_Reputation.IsFactionParagon(factionID) ) then
				local paragonFrame = CfReputationFrame.paragonFramesPool:Acquire()
