...
CommunitiesFrame:HookScript("OnUpdate", function(self)
	...
	if displayMode == COMMUNITIES_FRAME_DISPLAY_MODES.MINIMIZED then
		...
		ClubFinderGuildFinderFrame.OptionsList.TankRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderGuildFinderFrame.OptionsList.TankRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("TANK"))
		ClubFinderGuildFinderFrame.OptionsList.HealerRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderGuildFinderFrame.OptionsList.HealerRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("HEALER"))
		ClubFinderGuildFinderFrame.OptionsList.DpsRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderGuildFinderFrame.OptionsList.DpsRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("DAMAGER"))

		ClubFinderCommunityAndGuildFinderFrame.OptionsList.TankRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderCommunityAndGuildFinderFrame.OptionsList.TankRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("TANK"))
		ClubFinderCommunityAndGuildFinderFrame.OptionsList.HealerRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderCommunityAndGuildFinderFrame.OptionsList.HealerRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("HEALER"))
		ClubFinderCommunityAndGuildFinderFrame.OptionsList.DpsRoleFrame.Icon:SetTexture("Interface\\LFGFrame\\UI-LFG-ICON-ROLES")
		ClubFinderCommunityAndGuildFinderFrame.OptionsList.DpsRoleFrame.Icon:SetTexCoord(GetTexCoordsForRole("DAMAGER"))
