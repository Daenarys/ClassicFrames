...
local function GetSettings()
    return ClassicFrames.db.profile.minimap
end

function CfMinimapSettings:GetMinimapEnabled()
    return GetSettings().enableMinimap
end

function CfMinimapSettings:SetMinimapEnabled(_, value)
    GetSettings().enableMinimap = value
    ReloadUI()
end

function CfMinimapSettings:RebuildFrames()
    if (GetSettings().enableMinimap) then
